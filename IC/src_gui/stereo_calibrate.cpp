...
int calibStereo(int argc, char *argv[]);


int main(int argc, char** argv)
{

    argv[1] = "list_calib10_2b.txt\0";
    argv[2] = "8\0"; // pay attention, count the number of crosspoints (so one less the number of squares)
    argv[3] = "6\0"; // idem
    argv[4] = "35\0";
    argc = 5;
	calibStereo(argc, argv);
